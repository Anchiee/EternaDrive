    ...
    return (
        <AppLayout title="Terms of Service">
            <div className="container mx-auto p-6">
                <h1 className="text-2xl font-bold text-red-800 tracking-widest">Terms of Service for EternaDrive</h1>
                <p className="text-white-300 text-xs mb-3">Last Updated: 03.05.2025</p>
                
                <h2 className=" text-red-800 text-xl font-semibold">1. Acceptance of Terms</h2>
                ...
                <h2 className=" text-red-800 text-xl font-semibold">2. User Accounts</h2>
                <h3 className=" text-red-800 text-medium mt-4 font-semibold">2.1 Registration</h3>
                ...
                <h3 className=" text-red-800 text-xl font-semibold">2.2 Security</h3>
                ...
                <h3 className=" text-red-800 text-xl font-semibold">2.3 Termination</h3>
                ...
                <h2 className=" text-red-800 text-xl font-semibold">3. Use of Services</h2>
                <h3 className=" text-red-800 text-medium mt-4 font-semibold">3.1 Acceptable Use</h3>
                ...
                <h3 className=" text-red-800 text-xl font-semibold">3.2 Content Ownership</h3>
                ...
                <h2 className=" text-red-800 text-xl font-semibold">4. Privacy</h2>
                ...
                <h2 className=" text-red-800 text-xl font-semibold">5. Service Availability</h2>
                ...
                <h2 className=" text-red-800 text-xl font-semibold">6. Limitation of Liability</h2>
                ...
                <h2 className=" text-red-800 text-xl font-semibold">7. Changes to These Terms</h2>
