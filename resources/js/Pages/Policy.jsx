    ...
    return (
        <AppLayout title="Privacy Policy">
            <div className="container mx-auto p-6">
                ...
                <h2 className="text-red text-xl font-semibold">1. Information We Collect</h2>
                <p className="text-white-300 text-xs mb-3">We may collect the following types of information:</p>
                
                <h3 className="text-red text-medium mt-4 font-semibold">1.1 Personal Information</h3>
                ...
                <h3 className="text-red text-medium mt-4 font-semibold">1.2 Usage Information</h3>
                ...
                <h3 className="text-red text-medium mt-4 font-semibold">1.3 Uploaded Content</h3>
                ...
                <h2 className="text-red text-xl font-semibold">2. How We Use Your Information</h2>
                ...
                <h2 className="text-red text-xl font-semibold">3. How We Share Your Information</h2>
                ...
                <h2 className="text-red text-xl font-semibold">4. Data Security</h2>
                ...
                <h2 className="text-red text-xl font-semibold">5. Your Rights and Choices</h2>
                ...
                <h2 className="text-red text-xl font-semibold">6. Cookies and Tracking Technologies</h2>
                ...
                <h2 className="text-red text-xl font-semibold">7. Changes to This Privacy Policy</h2>
